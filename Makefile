...
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], HTML::TreeBuilder::XPath=>q[0], WWW::Mechanize=>q[0], Carp=>q[0] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    HTML::TreeBuilder::XPath:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTML::TreeBuilder::XPath" />' >> $(DISTNAME).ppd
